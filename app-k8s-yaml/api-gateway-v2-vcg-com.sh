        ...
        - name: ${Service}
          ...
          env:
            - name: aliyun_logs_${Service}     ## 日志服务
              value: stdout
            - name: aliyun_logs_${Service}-error
              value: /usr/local/openresty/nginx/logs/error_80.log
            - name: aliyun_logs_${Service}-access
              value: /usr/local/openresty/nginx/logs/access_80.log
